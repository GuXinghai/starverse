...
- Slices 1–7 are complete, including Settings integration, Cloud/User Rules workflows, UI-safe services/IPC, Facts Inspector, exact Model Picker deep-links, and modal focus behavior. Goal 3 priority/merge/winner/conflict/final `capabilityRevision` remains deferred, and the removed bundled/query-bound/request-time Rules authority must not return as a fallback.
