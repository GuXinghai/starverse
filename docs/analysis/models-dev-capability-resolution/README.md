...
- Slice 6 committed User Rules and durable draft/import-export lifecycle is next. Goal 3 priority/merge/winner/conflict/final `capabilityRevision` remains deferred, and the removed bundled/query-bound/request-time Rules authority must not return as a fallback.
