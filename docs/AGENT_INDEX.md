...
| **models.dev / model capability authority analysis** | `docs/analysis/models-dev-capability-resolution/README.md` → current Generation V2 authority | `src/shared/modelCatalog/`, `src/next/modelCatalog/`, `src/next/generation-v2/`, provider authority services and codecs | Historical evidence bundle only; reverify external facts and require one resolved capability revision across catalog, UI, preflight, runtime, and compiler |
...
- [analysis/models-dev-capability-resolution/README.md](analysis/models-dev-capability-resolution/README.md) — Independent models.dev and unified-capability-resolution evidence bundle
