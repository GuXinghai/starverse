...
| **File conversion & preview / DFC** | `docs/file-pipeline/document-format-conversion/starverse_format_conversion_preview_v1_2.md` → `docs/file-pipeline/document-format-conversion/important-context.md` → `docs/file-pipeline/document-format-conversion/dfc-m32-deadline-closeout-demo-readiness.md` | `src/shared/files/`, `infra/files/`, check DFC topic ledger before coding | v1.2 is authoritative. Do not follow archived v1.0 Hybrid / mixed send strategy or old file-card modal UI docs |
