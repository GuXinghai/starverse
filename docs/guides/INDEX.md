...
- 及其他文件（见 [guides/ 目录](#guides---开发指南-9-个文档)）
...
|------|--------|--------|------|
| 主目录文档数 | 130+ | 80 | **↓ 38%** |
| 归档文档 | 0 | 53+ | complete: 历史可查 |
| 已删除重复 | - | 13 | complete: 消除冗余 |
| 子目录结构 | 不完整 | 完善 | complete: 分类清晰 |
| 状态模型 | 单维度 | 双维度 | complete: 更精确 |
| DEBUG 文档 | 根目录散落 | 归档到 archive/debug/ | complete: 治理合规 |
| pending-classification | 未登记 | 10 个目录已登记 | complete: 可追踪 |
