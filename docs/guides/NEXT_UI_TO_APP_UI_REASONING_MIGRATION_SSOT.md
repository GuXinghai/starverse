...
### 3.1 推理面板链路
- next-ui 入口： src/ui-next/components/ChatNextReasoningPanel.vue
...
### 3.3 next-ui 推理控制入口
- UI 控件： src/ui-next/components/ChatNextComposer.vue
- 应用入口与参数拼装： src/ui-next/AppChatNext.vue
...
来源： src/ui-next/components/ChatNextReasoningPanel.vue
...
来源： src/ui-next/components/ChatNextComposer.vue
...
- [x] 统一转换逻辑（auto → omit reasoning field）
  - 参考： src/ui-next/AppChatNext.vue
...
- [x] 监听 db 同步事件（如需）
  - 事件来源： src/ui-next/AppChatNext.vue
