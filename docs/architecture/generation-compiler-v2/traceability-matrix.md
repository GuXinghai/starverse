...
Baseline source: `[owner-local-baseline]` (1,932 lines, read 2026-07-13).
...
| BL-10 | 827–910 | Anthropic thinking, sampling, web, continuation, image capability | TP7 | Complete | The user-facing `thinking.display` semantic is frozen as `provider_default|summarized|omitted` (default `summarized`) with exact omission/encoding and native continuation preservation; the model rule matrix remains a Goal 2 prerequisite. |
