...
import {
  cleanupExpiredProviderScopedCatalogCaches,
  type CatalogCleanupRunResult,
} from '../modelCatalog/providerCatalogCacheCleanup'
...
export async function cleanupExpiredOpenRouterScopedCatalogCaches(input: Readonly<{
  ...
  return cleanupExpiredProviderScopedCatalogCaches({
    ...input,
