...
export function createAnthropicToolContinuationCoordinatorV2(input: Readonly<{ db: BetterSqlite3.Database; credentialService: Epoch2RuntimeCredentialService; nowMs?: () => number }>) {
