...
function setup() {
  ...
  const message = db.prepare(`INSERT INTO message_v2(message_id,conversation_id,role,status,parent_message_id,question_id,answer_root_id,ordinal,created_at_ms,updated_at_ms)
  ...
  db.prepare('INSERT INTO branch_v2 VALUES (?,?,?,?,?,?,?)').run('branch:1', 'conversation:1', 'answer:2', null, 4, 4, null)
