...
describe('dbMethodsRegistry', () => {
  ...
  it('derives renderer allowlist from registry flags', () => {
    ...
    expect(DB_RENDERER_METHOD_SET.has('fileAsset.create')).toBe(false)
    expect(DB_RENDERER_METHOD_SET.has('fileAsset.softDelete')).toBe(false)
    expect(DB_RENDERER_METHOD_SET.has('fileAsset.planPhysicalCleanup')).toBe(false)
    expect(DB_RENDERER_METHOD_SET.has('fileDerivative.create')).toBe(false)
    expect(DB_RENDERER_METHOD_SET.has('fileDerivative.getById')).toBe(false)
    expect(DB_RENDERER_METHOD_SET.has('fileDerivative.listByParentAssetId')).toBe(false)
    expect(DB_RENDERER_METHOD_SET.has('fileDerivative.getLatestReady')).toBe(false)
