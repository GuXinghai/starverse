...
export class DbWorkerRuntime {
  ...
  *iterateFinalMessageDocs(): Iterable<SearchDocInput> {
  ...
  private registerHandlers() {
    ...
    registerProjectHandlers(register, this)
    registerConvoMessageHandlers(register, this)
    registerBranchContextHandlers(register, this)
    registerSearchMaintenanceHandlers(register, this)
    registerUsagePrefsSettingsHandlers(register, this)
