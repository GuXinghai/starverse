...
const compatibleRendererCredentialSchema = z.object({
  ...
  diagnosticCode: z.string().trim().min(1).max(128).optional(),
  storageBackend: z.enum(['electron_safe_storage', 'session', 'plaintext']).optional(),
  sessionOverridesPersistent: z.boolean(),
