...
export function decodeGeminiPlainTextRetryCommandV2(value: unknown): GeminiPlainTextRetryCommandV2 {
  try {
    ...
    const command = Object.freeze({ ...projection, actionKind: raw.actionKind, operationId, branchId, questionId,
      targetAnswerRootId, expectedHeadMessageId, ...fingerprint(projection) }) as GeminiPlainTextRetryCommandV2
...
export type GeminiPlainTextRegenerateCommandV2 = Readonly<{
  schemaVersion: 1; kind: 'gemini_plain_text_regenerate_question'; operationId: Identity<'operation_id'>
...
export type GeminiPlainTextEditResendCommandV2 = Readonly<{
  schemaVersion: 1; kind: 'gemini_plain_text_edit_resend'; operationId: Identity<'operation_id'>; mode: 'fork' | 'replace'
