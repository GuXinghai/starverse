...
export function decodeOpenAIResponsesPlainTextInitialSendCommandV2(
  ...
  try {
    ...
    const commandAttachments = decodeOpenAIResponsesCommandAttachmentsV2(raw.commandAttachments)
    const projection = Object.freeze({
      schemaVersion: 1 as const, kind: 'openai_responses_plain_text_initial_send' as const,
