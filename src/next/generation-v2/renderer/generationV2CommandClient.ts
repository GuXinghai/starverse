...
import type { LocalProviderRouteKind } from '../../../shared/provider/localProviderRouteDescriptor'
...
export type GenerationV2Route =
  ...
  | Readonly<{kind:'openai_chat_compatible'}>|Readonly<{kind:LocalProviderRouteKind}>
